...
const Navbar: FC = () => {
  ...
  const insertTable = ({ rows, cols }: PnsertTableAttr) => {
              ...
              <MenubarMenu>
                ...
                <MenubarContent>
                  <MenubarSub>
                    ...
                    <MenubarSubContent>
                      <MenubarItem
                        onClick={insertTable.bind(null, { rows: 1, cols: 1 })}
                      >
                        1 X 1
                      </MenubarItem>
                      <MenubarItem
                        onClick={insertTable.bind(null, { rows: 2, cols: 2 })}
                      >
                        2 X 2
                      </MenubarItem>
                      <MenubarItem
                        onClick={insertTable.bind(null, { rows: 3, cols: 3 })}
                      >
                        3 X 3
                      </MenubarItem>
                      <MenubarItem
                        onClick={insertTable.bind(null, { rows: 4, cols: 4 })}
                      >
                        4 X 4
                      </MenubarItem>
                    </MenubarSubContent>
