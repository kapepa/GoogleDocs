...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const organizationId = (user.organization ?? undefined) as string | undefined;
...
export const get = query({
  ...
  handler: async (ctx, args) => {
    ...
    const organizationId = (user.organization ?? undefined) as string | undefined;
    if (!!search && !!organizationId) return await ctx
      .db.query("documents")
    ...
    if (!!organizationId) return ctx.db
      .query("documents")
...
export const removeById = mutation({
  ...
  async handler(ctx, args) {
    ...
    const isOrganizationMember = !!(document.organizationId === organizationId && document.organizationId == organizationId);
